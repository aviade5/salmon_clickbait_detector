...
class Clickbait_Challenge_Evaluator(AbstractController):
    ...
    def execute(self, window_start=None):
        ...
        self._reversed_targeted_class_dict = {num: targeted_class for targeted_class, num in self._targeted_class_dict.iteritems()}
        ...
        for targeted_class, num in self._targeted_class_dict.iteritems():
