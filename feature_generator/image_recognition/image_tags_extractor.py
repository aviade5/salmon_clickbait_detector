...
from commons.schema_definition import Image_Tags
...
class Image_Tags_Extractor(AbstractController):
    def __init__(self, db):
        ...
        self._max_request_to_service = self._dataset_folder = self._config_parser.eval(self.__class__.__name__,
                                                                                       "max_request_to_service")
    ...
    def execute(self, window_start):
        ...
        for author in authors:
            print("\rprocessed author: " + str(counter), end="")
            counter += 1
