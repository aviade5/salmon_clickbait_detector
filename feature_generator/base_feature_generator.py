...
from commons.schema_definition import AuthorFeatures
...
class BaseFeatureGenerator():
        ...
        for author in self.authors:
            ...
            if author_guid in self.author_guid_posts_dict.keys():
                ...
                for feature in features:
                    author_feature = self.run_and_create_author_feature(author, feature, posts, feature, author_guid)
    ...
    def run_and_create_author_feature(self, author, feature, posts, feature_name, id_val):
        try:
